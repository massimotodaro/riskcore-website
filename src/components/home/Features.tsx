            ...
            <g key={i}>
              ...
              <motion.path
                ...
                animate={{
                  ...
                  pathOffset: (isDisappearing || shouldBeHidden) ? 1 : 0,
                  opacity: shouldBeHidden ? 0 : (shouldShow ? 1 : (isDisappearing ? 1 : 0))
                }}
                transition={{
                  pathLength: { duration: isAllVisible ? 0.8 : 1.2, ease: "easeInOut" },
                  pathOffset: { duration: isDisappearing ? 0.8 : 0, ease: "easeInOut" },
                  opacity: { duration: shouldBeHidden ? 0 : (isDisappearing ? 0.8 : (isAllVisible ? 1.0 : 0.3)), ease: "easeInOut" }
                }}
              />
              ...
              <motion.path
                ...
                initial={{ opacity: 0 }}
                animate={{
                  opacity: (isDisappearing || shouldBeHidden) ? 0 : (shouldShow ? 1 : 0)
                }}
                transition={{
