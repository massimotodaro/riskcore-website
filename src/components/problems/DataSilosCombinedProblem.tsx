...
/**
 * DataSilosCombinedProblem.tsx
 *
 * Combined component merging Data Silos visualization with
 * the System Fragmentation problem statement and industry quote.
 */
...
export default function DataSilosCombinedProblem() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-slate-100 font-['Space_Grotesk'] mb-4">
            Data Silos <span className="text-blue-400">Everywhere</span>
          </h2>
        ...
        <div className="flex justify-center mt-8">
          <motion.div
            ...
            className="bg-gradient-to-br from-blue-500/5 to-cyan-500/5 border border-blue-500/20 rounded-2xl px-8 py-5 mb-12"
            ...
            <div className="flex items-center gap-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-400">No Unified View</p>
                </div>
              </div>
        ...
        {/* System Fragmentation Card with Quote */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
