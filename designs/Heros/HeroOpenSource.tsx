 ...
 * For decision-makers who value transparency and dev teams
...
function CTAButtons() {
  return (
    ...
    >
      <motion.a
        href="https://github.com/riskcore/riskcore"
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center gap-2 px-8 py-4 bg-slate-100 hover:bg-white text-slate-900 font-bold text-lg rounded-xl transition-colors"
