...
/**
 * RiskPodsFullSpectrum.tsx
 *
 * RiskPods Section Variant 3: "The Full Spectrum"
 *
 ...
 *
 * Target: PMs, CIOs who want the big picture
 *
 * Usage:
 *   <RiskPodsFullSpectrum />
 *
 * Dependencies:
...
export default function RiskPodsFullSpectrum() {
        ...
        >
          <div className="flex flex-wrap justify-center gap-3 mb-8">
            {[
              ...
              <motion.span
                key={feature}
                className="px-3 py-1.5 bg-slate-800/50 border border-white/10 rounded-full text-sm text-slate-400"
                initial={{ opacity: 0, scale: 0.9 }}
                animate={isInView ? { opacity: 1, scale: 1 } : {}}
          ...
          <motion.button
            className="px-10 py-5 bg-emerald-500 hover:bg-emerald-400 text-slate-900 font-bold text-xl rounded-xl transition-colors shadow-lg shadow-emerald-500/25"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
            See Your Risk Spectrum
          </motion.button>
