    ...
    <section className="relative py-24 overflow-hidden" style={{ background: 'linear-gradient(to bottom, #0a0f1a, #151E31)' }}>
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <motion.div
          ...
          className="mt-20 pt-[20%] max-w-4xl mx-auto"
        >
          ...
          {/* Risk Report box - Red outline pill, 70% width */}
          <div className="flex justify-center">
            <div
              className="flex items-center justify-center gap-5 px-10 py-4 rounded-full w-[70%]"
              style={{
